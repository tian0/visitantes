...
module.exports = {
    ...
    connect: () => {
        ...
        if (this.connection)
            ...
            mongoose.connect(process.env.MONGODB_URL || 'mongodb://localhost:27017/mongo-1', { useNewUrlParser: true }) //opens connection to DB, was mongoose.connect(CONFIG.DB_CONNECTION), see line 2
            .then((connection) => {
